def summary_prompt(summary_type: str):
    ...
    prompt = (
        f"""You are an expert writer tasked with crafting a section of a structured summary based on the provided document chunk. Your goal is to create a summary. 
...
def generate_final_summary(summary_type: str, text_was_splitted: bool):
    ...
    if text_was_splitted:
        prompt = (
            f"""You are an expert writer tasked with combining multiple summaries sections into a single, cohesive, and well-structured summaries. Your goal is to create a unified document that reads as a complete academic summary.
        ...
        prompt = (
            f"""You are an expert writer tasked with crafting a section of a structured summary based on the provided document text. Your goal is to create a summary. 
